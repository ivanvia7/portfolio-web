      ...
      <div className="projects-section-wrapper" id="projects-section">
        ...
        <div className="projects-modules-wrapper">
          ...
          <ProjectModule
            ...
            projectDescription="This project was developed during a 2024 coding boot camp, where I built a full-stack application for managing listings. The platform enables users to post and share their favorite camps effortlessly.
